...
List<dynamic>users=[];
List names = [' Daniel Ceaser',' Taylor Jad',' Chiru Paji',' Samy Tamy',' Hero Lal',' Landon Mcbroom',' Cole Spouse'];
  List locations = ['  London','  Usa','  Usa','  Kohalpur','  Humla','  Jumla','  Hngk'];
  @override
        ...
        //  _top(),
           ...
           const Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text('Plumbing',style:TextStyle(fontWeight: FontWeight.bold,fontSize: 25.0),),
                   SizedBox(
                   height: 20,
                ),
                    ...
                    Container(
                      ...
                      child: const CircleAvatar(
                       backgroundColor: Colors.green,
                        ...
                        backgroundImage: NetworkImage("assets/profiles/and.jpg"),
                      ),
                    ),
